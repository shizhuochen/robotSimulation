    ...
    public class SimulationMain : Microsoft.Xna.Framework.Game
    {
        ...
        private void ReadParametersFromFile()
        {
            ...
            try
            {
                ...
                //const string fileName = "inputDat.dat";
                //if (File.Exists(fileName))
                //{
                //    using (BinaryReader reader = new BinaryReader(File.Open(fileName, FileMode.Open)))
                //    {
                //        this.config.robotSpeed = (float)reader.ReadDouble();
                //        this.config.robotChangeDirectionThreshholdValue = reader.ReadInt32();
                //        this.config.robotTurnRatio = reader.ReadInt32();
                //        this.config.UpdateSquareDimForAnalysis = (short)reader.ReadInt32();
                //    }
                //}
        ...
        {
            //// Write binary file. 
            //const string fileName = "resultsDat.dat";
